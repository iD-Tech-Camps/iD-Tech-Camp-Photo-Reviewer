// Leaderboard screen — now also surfaces personal stats

function LeaderboardScreen() {
  const [scope, setScope] = React.useState('weekly'); // weekly | monthly | all
  const [view, setView]  = React.useState('individual'); // individual | team
  ...
  return (
    <>
      ...
      <div className="page-body">
        {/* Personal stats strip — moved from Home */}
        <div style={{
          display: 'grid',
  ...
  return (
    <>
      ...
      <div className="page-body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        {/* Rubric — first, so reviewers read the criteria before the examples */}
...
Object.assign(window, { LeaderboardScreen, ProfileScreen, GuideScreen });
