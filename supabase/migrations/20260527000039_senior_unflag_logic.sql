...
-- Part 2 of 2 — function + policy that reference the enum value added in
-- 20260527000038_senior_unflag.sql. Both statements are idempotent so this
-- is a safe no-op on environments where the original combined migration
-- already applied.
